...
class serverSync {
    ...
    private function _putPageIntoDB () {
        // 1. Проверяем, есть ли рассказ в БД
        // 1.1 Если есть то апдейтим рейтинг
        // 1.2 Если нет, то:
        // 1.2.1 Добавляем автора (если нет с таким именем)
        // 1.2.2 Добавляем категории (если нет с таким именем)
        // 1.2.2 Добавляем рассказ
